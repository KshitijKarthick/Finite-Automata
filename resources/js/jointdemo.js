...
$("#v-2").attr("preserveAspectRatio", "xMinYMax meet");
...
var star  = state(500, 400, 'star');
var line  = state(190, 100, 'line');
var block = state(460, 140, 'block');
...
link(slash, block, '*');
link(block, star,  '*');
link(star,  block, 'other', [{x: 550, y: 290}]);
link(star,  code,  '/',     [{x: 490, y: 310}]);
link(line,  line,  'other', [{x: 115,y: 100}, {x: 250, y: 50}]);
link(block, block, 'other', [{x: 485,y: 140}, {x: 520, y: 90}]);
